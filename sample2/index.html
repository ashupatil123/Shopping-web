  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="carousel-item active">
      ...
      <div class="carousel-caption text-center">
        <div class="animated fadeInDown">
          <h3 class="h3-responsive">ShopMask</h3>
          <p>First text</p>
        </div>
      </div>
      <!--Caption-->
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-caption">
        <div class="animated fadeInDown">
          <h3 class="h3-responsive">Super light Collection...</h3>
          <p>Secondary text</p>
        </div>
      </div>
      <!--Caption-->
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-caption">
        <div class="animated fadeInDown">
          <h3 class="h3-responsive">Now To Connect With Us..</h3>
          <p>Third text</p>
        </div>
      </div>
      <!--Caption-->
		...
		<div class="row text-center py-5">
			...
			<div class="col-lg-4 col-md-4 ">
				<form action="add.php" method="post">
					<div class="card shadow">
						<div>
							<img src="img1.jpg" alt="Image" class="img-fluid Cart-img-top">
						</div>
						<div class="card-body">
			...
			<div class="col-lg-4 col-md-4 ">
				<form action="add.php" method="post">
					<div class="card shadow">
						<div>
							<img src="img2.jpg" alt="Image" class="img-fluid Cart-img-top">
						</div>
						<div class="card-body">
			...
			<div class="col-lg-4 col-md-4">
				<form action="add.php" method="post">
					<div class="card shadow">
						<div>
							<img src="img11.jpg" alt="Image" class="img-fluid Cart-img-top">
						</div>
						<div class="card-body">
			...
			<div class="col-lg-4 col-md-4">
				<form action="add.php" method="post">
					<div class="card shadow">
						<div>
							<img src="img4.jpg" alt="Image" class="img-fluid Cart-img-top">
						</div>
						<div class="card-body">
